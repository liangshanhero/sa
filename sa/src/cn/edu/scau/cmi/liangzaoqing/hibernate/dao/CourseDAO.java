...
public class CourseDAO extends BaseHibernateDAO {
	...
	public Course findById(java.lang.Long id) {
		...
		try {
			Course instance = (Course) getSession().get("cn.edu.scau.cmi.liangzaoqing.hibernate.Course", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Course instance) {
		...
		try {
			List results = getSession().createCriteria("cn.edu.scau.cmi.liangzaoqing.hibernate.Course")
